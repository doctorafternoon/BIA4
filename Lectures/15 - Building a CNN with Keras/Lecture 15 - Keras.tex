...
\author{Duncan MacGregor - duncan.macgregor@ed.ac.uk
\\\\Original lecture by Nicola Romano - nicola.romano@ed.ac.uk}
    ...
    \begin{columns}
        ...
        \begin{column}{.7\textwidth}
            ...
            \begin{itemize}
                ...
                \item The \texttt{keras} package also supports other "backends" (like JAX or PyTorch).
            \end{itemize}
        \end{column}
    \end{columns}
    \raggedright
